          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _buildFilterChip(isTeacher?'Parents':'Teachers', theme),
                const SizedBox(width: Sizes.spaceS),
            ...
            child: ListView(
              ...
              children: [
                ChatListItem(
                  ...
                  name: 'Mrs. Akunne (Ebele\'s ${isTeacher?'Parent':'Teacher'})',
                ...
                ChatListItem(
                  ...
                  name: 'Mr Segun (Chinedu\'s ${isTeacher?'Parent':'Teacher'})',
                  preview: 'Thank you for the update on her',
                  time: '10:24',
                  unreadCount: 2,
                  onTap: ()=> context.push(AppRoutes.chatDetail),
                ...
                ChatListItem(
                  ...
                  name: 'Mrs. Obi (Ifeanyi\'s ${isTeacher?'Parent':'Teacher'})',
                  preview: 'Thank you for the update on her',
                  time: '10:24',
                  unreadCount: 2,
                  onTap: ()=> context.push(AppRoutes.chatDetail),
